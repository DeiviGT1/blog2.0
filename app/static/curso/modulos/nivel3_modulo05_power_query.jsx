...
const SECTIONS = [{ title: "Que es Power Query", content: [{ type: "text", value: "Herramienta en Data > Get and Transform Data. Importa, limpia, transforma y carga datos. Cada paso queda grabado: Refresh reprocesa automaticamente." }] }, { title: "El Editor", content: [{ type: "definition_list", items: [{ term: "Applied Steps", def: "Panel derecho. Lista de transformaciones editable." }, { term: "Preview", def: "Panel central. Vista previa despues de cada paso." }, { term: "Queries panel", def: "Panel izquierdo. Lista de queries existentes." }] }] }, { title: "Importar datos", content: [{ type: "definition_list", items: [{ term: "From File", def: "Excel, CSV, Text, XML, JSON, PDF." }, { term: "From Table/Range", def: "Convierte tabla existente en query." }, { term: "From Web", def: "Extrae tablas de paginas web." }] }] }, { title: "Transformaciones esenciales", content: [{ type: "definition_list", items: [{ term: "Remove Columns", def: "Elimina columnas innecesarias." }, { term: "Filter Rows", def: "Filtra por condiciones." }, { term: "Change Type", def: "Cambia tipo de dato." }, { term: "Split Column", def: "Parte por delimitador." }, { term: "Unpivot", def: "Convierte columnas en filas. Esencial para tablas cruzadas." }] }] }, { title: "Close and Load", content: [{ type: "definition_list", items: [{ term: "A nueva hoja", def: "Close and Load carga como Table." }, { term: "Solo conexion", def: "Only Create Connection. Sin tabla visible." }] }] }, { title: "Refresh", content: [{ type: "text", value: "Data > Refresh All reprocesa todo. Procesos de 30 min en 5 segundos. M Language, Merge/Append y parametros se cubren en Nivel 4." }] }];
    ...
    <div style={{ maxWidth: 680, margin: "0 auto", padding: "0.5rem 0 2rem" }}>
      <div style={{ marginBottom: "1.5rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
          ...
          <span style={{ fontSize: 12, color: "var(--color-text-tertiary)" }}>Modulo 5 de 8</span>
        </div>
        <h1 style={{ fontSize: 22, fontWeight: 500, color: "var(--color-text-primary)", margin: "0 0 6px" }}>Introduccion a Power Query</h1>
        <p style={{ fontSize: 14, color: "var(--color-text-secondary)", margin: 0, lineHeight: 1.6 }}>Importa, transforma y limpia datos automaticamente desde el Power Query Editor.</p>
      </div>
      <div style={{ background: V[50], borderLeft: `3px solid ${V[400]}`, borderRadius: "0 var(--border-radius-md) var(--border-radius-md) 0", padding: "12px 16px", marginBottom: "1.5rem" }}>
        ...
        <p style={{ fontSize: 13, color: V[800], margin: 0, lineHeight: 1.6 }}>Que entiendas Power Query y puedas importar y transformar datos basicos.</p>
      </div>
      ...
      <div style={{ background: "var(--color-background-secondary)", borderRadius: "var(--border-radius-lg)", padding: "1.25rem", marginTop: "1.5rem" }}>
        ...
        {["Power Query graba cada paso. Refresh reprocesa automaticamente.", "Applied Steps es la lista editable de transformaciones.", "Remove Columns, Filter, Change Type, Split Column son las mas usadas.", "Close and Load envia datos a Excel como Table.", "Refresh All reprocesa todo. El verdadero poder de Power Query."].map((p, i) => (
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "1.5rem", paddingTop: "1rem", borderTop: "0.5px solid var(--color-border-tertiary)" }}>
        <span style={{ fontSize: 13, fontWeight: 500, color: V[600] }}>Anterior: PivotTables avanzadas</span>
        <span style={{ fontSize: 13, fontWeight: 500, color: V[600] }}>Siguiente: Dashboards interactivos</span>
      </div>
    </div>
  );
}
