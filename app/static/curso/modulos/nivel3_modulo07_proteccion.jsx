...
const SECTIONS = [{ title: "Protect Sheet", content: [{ type: "definition_list", items: [{ term: "Proceso", def: "Desbloquea celdas editables primero (Format Cells > Protection). Luego Review > Protect Sheet." }, { term: "Permisos", def: "Elige que permite: seleccionar, Sort, Filter, insertar." }, { term: "Contrasena", def: "Opcional. Sin ella previene accidentes." }] }] }, { title: "Protect Workbook", content: [{ type: "text", value: "Review > Protect Workbook. Protege estructura: no agregar/eliminar/renombrar Sheets. Complementa Protect Sheet." }] }, { title: "Trace Precedents y Dependents", content: [{ type: "definition_list", items: [{ term: "Precedents", def: "Formulas > Trace Precedents. Flechas desde celdas que alimentan la formula." }, { term: "Dependents", def: "Formulas > Trace Dependents. Flechas hacia celdas que usan este dato." }, { term: "Remove Arrows", def: "Limpia las flechas de auditoria." }] }] }, { title: "Herramientas de depuracion", content: [{ type: "definition_list", items: [{ term: "Error Checking", def: "Formulas > Error Checking. Busca errores en toda la hoja." }, { term: "Evaluate Formula", def: "Paso a paso como Excel resuelve una formula." }, { term: "Show Formulas", def: "Ctrl+` muestra formulas en vez de resultados." }, { term: "Watch Window", def: "Monitorea celdas desde cualquier hoja." }] }] }];
    ...
    <div style={{ maxWidth: 680, margin: "0 auto", padding: "0.5rem 0 2rem" }}>
      <div style={{ marginBottom: "1.5rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
          ...
          <span style={{ fontSize: 12, color: "var(--color-text-tertiary)" }}>Modulo 7 de 8</span>
        </div>
        <h1 style={{ fontSize: 22, fontWeight: 500, color: "var(--color-text-primary)", margin: "0 0 6px" }}>Proteccion y auditoria</h1>
        <p style={{ fontSize: 14, color: "var(--color-text-secondary)", margin: 0, lineHeight: 1.6 }}>Protect Sheet/Workbook, Trace Precedents/Dependents, Error Checking, Watch Window.</p>
      </div>
      <div style={{ background: V[50], borderLeft: `3px solid ${V[400]}`, borderRadius: "0 var(--border-radius-md) var(--border-radius-md) 0", padding: "12px 16px", marginBottom: "1.5rem" }}>
        ...
        <p style={{ fontSize: 13, color: V[800], margin: 0, lineHeight: 1.6 }}>Que protejas archivos y depures formulas con herramientas de auditoria.</p>
      </div>
      ...
      <div style={{ background: "var(--color-background-secondary)", borderRadius: "var(--border-radius-lg)", padding: "1.25rem", marginTop: "1.5rem" }}>
        ...
        {["Desbloquea celdas editables ANTES de Protect Sheet.", "Protect Workbook protege estructura. Complementa Protect Sheet.", "Trace Precedents/Dependents muestra dependencias visualmente.", "Evaluate Formula y Ctrl+` son esenciales para depurar.", "Watch Window monitorea celdas clave desde cualquier hoja."].map((p, i) => (
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "1.5rem", paddingTop: "1rem", borderTop: "0.5px solid var(--color-border-tertiary)" }}>
        <span style={{ fontSize: 13, fontWeight: 500, color: V[600] }}>Anterior: Dashboards interactivos</span>
        <span style={{ fontSize: 13, fontWeight: 500, color: V[600] }}>Siguiente: Colaboracion y buenas practicas</span>
      </div>
    </div>
  );
}
